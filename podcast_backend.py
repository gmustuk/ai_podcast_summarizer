...
def get_transcribe_podcast(rss_url, local_path):
 ...
 ## LOGIC HERE TO RETURN THE SUMMARY OF THE PODCAST USING OPENAI
...
def get_podcast_summary(podcast_transcript):
    ...
    instructPrompt = """
    Given the following transcript of a podcast episode, please provide a concise and informative summary that captures the main points, insights, and takeaways. Present the summary in an easy-to-read format that can be understood by a general audience.
    """
...
def get_podcast_guest(podcast_transcript):
        ...
        functions=[
            {
                ...
                "description": "Get podcast guest information from the transcript",
                "parameters": {
                    "type": "object",
                    "properties": {
                        "guest_name": {
                            "type": "string",
                            "description": "Podcast guest name",
                        },
                        "unit": {"type": "string"},
                    },
                    "required": ["guest_name"],
    ...
    try:
        ...
        print(f"Could not find Wikipedia page for {podcast_guest}. Continuing without guest information.")
